...
-miphoneos-version-min=6.0 $ICU_FLAGS -pipe -arch x86_64 -no-cpp-precomp \
-isysroot $SDKROOT"
export LDFLAGS="-arch x86_64 -L$SDKROOT/usr/lib/ -isysroot $SDKROOT \
-Wl,-dead_strip -miphoneos-version-min=6.0"
ICU_PATH=$MY_DIR
