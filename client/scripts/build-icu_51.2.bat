...
::  Revision: $Id: build-icu.bat 4592 2013-09-26 15:30:25Z stathis $
::
:: Changelog:
::
...
SET PROJECT_SRC_DIR=E:\_Work\icu4c-51_2-src\icu

SET PROJECT_INSTALL_DIR=E:\_Work\icu-dist-!PROJECT_VERSION!-!VS_VERSION!
...
if /i "!arg[0]!" == "build" (
    ...
    if !argC! == 2 (
        ...
        echo.
        echo This feature is currently unsupported.
        echo.
...
echo.
bash -c "echo -n \"           SEVENZIP_CMD: \" & which !SEVENZIP_CMD!"
...
pushd "!PROJECT_SRC_DIR!"
    ...
    if /i "%~1" == "51.2" (
        ...
        call :applyPatch ICU_51.2_static_runtime_Cygwin_MSVC.patch
...
IF NOT EXIST "!PATCH_FILE!" (
    ...
    rem diff -uNr qsql_mysql.orig qsql_mysql.pri > qt-5.1.0-qsql_mysql.pri.patch
